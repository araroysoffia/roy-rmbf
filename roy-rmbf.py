...
class __crack__:
    ...
    def __api__(self, user, _yan_):
	    ...
	    user_agent = random.choice(["Mozilla/5.0 (Linux; Android 7.0; SM-G610F Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.91 Mobile Safari/537.36 OPR/60.3.3004.55692"])
                ...
                for yntks in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 1 or len(xz) == 2 or len(xz) == 3 or len(xz) == 4 or len(xz) == 5:
                            	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
                        elif len(xz) == 1:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[1], xz[1]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
                        elif len(xz) == 2:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[1], xz[1]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[2], xz[2]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
                        elif len(xz) == 3:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[1], xz[1]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[2], xz[2]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[3], xz[3]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
                        elif len(xz) == 4:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		...
                        		xz[2], xz[2]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[3], xz[3]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[4], xz[4]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
                        elif len(xz) == 5:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		...
                        		xz[3], xz[3]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[4], xz[4]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456', 
                        		xz[5], xz[5]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'123456',
                        	]
