...
class __crack__:
    ...
    def __api__(self, user, _yan_):
	    ...
	    ua_api = random.choice(['Nokia5130c-2/2.0 (07.97) Profile/MIDP-2.1 Configuration/CLDC-1.1 UCWEB/2.0 (Java; U; MIDP-2.0; ar-SA; Nokia5130c-2) U2/1.0.0 UCBrowser/9.4.1.377 U2/1.0.0 Mobile UNTRUSTED/1.0'])
    ...
    def __mfb__(self, user, _yan_):
	    ...
	    ua_mobile = random.choice(['NokiaC2-00/2.0 (03.45) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; kau; nokiac2-00) UCBrowser8.3.0.154/70/352/UCWEB Mobile', 'Nokia5300/2.0 (05.00) Profile/MIDP-2.0 Configuration/CLDC-1.1 Mozilla/5.0 (Windows; U; Windows 7; rv:11.1) Gecko/20100101 firefox/11.0 UNTRUSTED/1.0'])
