...
class __crack__:
    ...
    def __api__(self, user, _yan_):
	    ...
	    ua_api = random.choice(['Mozilla/5.0 (X11; RemixOS; CrOS x86_64; rv:50.0) Gecko/20100101 Firefox/50.0', 'Mozilla/5.0 (Linux; Android 5.1; Remix Mini Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.93 Safari/537.36'])
