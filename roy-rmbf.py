...
class __crack__:
    ...
    def __api__(self, user, _yan_):
	    ...
	    ua_api = random.choice(['Mozilla/5.0 (Linux; Android 10; Redmi Note 8T Build/QKQ1.200114.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.115 Mobile Safari/537.36 Instagram 198.0.0.32.120 Android (29/10; 440dpi; 1080x2130; Xiaomi/xiaomi; Redmi Note 8T; willow; qcom; ru_RU; 307053317)'])
