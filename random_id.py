...
def manual():
	...
	def main(user):
		...
		try:
			for asu in pw.split(","):
				ua_mb = 'Mozilla/5.0 (Linux; Android 6.0; Redmi 4X Build/MMB29M; xx-xx) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36'
