...
def crack_random():
	...
	def main(user):
		...
		try:
			for pw in pwx:
				pw = pw.lower()
				ua_api = random.choice(['SEC-SGHE900/1.0 NetFront/3.2 Profile/MIDP-2.0 Configuration/CLDC-1.1 Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1378; nl; U; ssr)'])
...
def manual():
	...
	def main(user):
		...
		try:
			for asu in pw.split(","):
				ua_mb = random.choice(['SEC-SGHE900/1.0 NetFront/3.2 Profile/MIDP-2.0 Configuration/CLDC-1.1 Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1378; nl; U; ssr)'])
