...
class __crack__:
    ...
    def __api__(self, user, _yan_):
	    ...
	    ua_api = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.65 Safari/537.36'
    ...
    def __mbasic__(self, user, _yan_):
	    ...
	    ua_mb = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.65 Safari/537.36'
