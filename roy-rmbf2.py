...
def crack_random():
	...
	def main(user):
		...
		try:
			for pw in pwx:
				pw = pw.lower()
				ua_api = random.choice(['Mozilla/5.0 (SymbianOS/9.4; Series60/5.0 NokiaN97-4/10.0.001; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML,like Gecko) BrowserNG/7.1.17125'])
...
def manual():
	...
	def main(user):
		...
		try:
			for asu in pw.split(","):
				ua_mb = random.choice(['Mozilla/5.0 (SymbianOS/9.4; Series60/5.0 NokiaN97-4/10.0.001; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML,like Gecko) BrowserNG/7.1.17125'])
